...
<br>
1. Navigate to the appropriate parent folder of where your project will be located. This example uses the a folder on the desktop called "class projects" folder. NOTE: Start from your home directory "~".
